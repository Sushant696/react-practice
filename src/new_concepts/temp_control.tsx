  ...
  return (
    <div >
      <Card style={{textAlign:'center'}}>
        ...
        <Button size="large" style={{margin:"1rem"}}  onClick={handleIncremet}>
          <CaretUpOutlined />
        </Button>
        <Button size="large" className="text-[34px]" >{temp}</Button>
    <Button size="large" style={{margin:"1rem"}} onClick={handleDecrement}   > 
          <CaretDownOutlined />
        </Button>
        <div><p></p></div>
      </Card>
